...
export const socialMediaProfiles = [
  { title: 'Linkedin', href: 'https://www.linkedin.com/in/shruti-pandey-7b179a202/', icon: LinkedinIcon },
  { title: 'GitHub', href: 'https://github.com/shrutipandey15', icon: GitHubIcon },
];
