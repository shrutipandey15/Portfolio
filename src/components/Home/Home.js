      ...
      <div className="home-section">
        <div className="home-content">
          <div className="home-section-left">
            ...
            <h2 className="heading-intro">Shruti Pandey</h2>
            <p className="heading-text">
              I am a Full stack developer focused on creating beautiful and
              user-friendly websites while writing clean code.
            </p>
            <Link
              to="projects"
